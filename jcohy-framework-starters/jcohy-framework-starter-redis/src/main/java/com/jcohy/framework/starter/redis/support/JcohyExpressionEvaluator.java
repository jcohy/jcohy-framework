 ...
 * @since 2022.0.1
 */
public class JcohyExpressionEvaluator extends CachedExpressionEvaluator {
    ...
    public EvaluationContext createContext(Method method, Object[] args, Object target, Class<?> targetClass,
        ...
        JcohyExpressionRootObject rootObject = new JcohyExpressionRootObject(method, args, target, targetClass,
                targetMethod);
    ...
    private Method getTargetMethod(Class<?> targetClass, Method method) {
        ...
        return this.methodCache.computeIfAbsent(methodKey,
