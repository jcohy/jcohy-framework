...
class StringsTest {
	...
	void isEmpty() {
		...
		assertThat(Strings.isEmpty("bob")).isEqualTo(false);
		assertThat(Strings.isEmpty("  bob  ")).isEqualTo(false);
	}

	@Test
	void isBlack() {
		assertThat(Strings.isBlack(null)).isEqualTo(true);
		assertThat(Strings.isBlack("")).isEqualTo(true);
		assertThat(Strings.isBlack(" ")).isEqualTo(true);
		assertThat(Strings.isBlack("bob")).isEqualTo(false);
		assertThat(Strings.isBlack("  bob  ")).isEqualTo(false);
	}
