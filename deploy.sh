...
WORK_DIR="/opt/jcohy-framework"
SERVICE_DIR="$WORK_DIR/jcohy-framework"
SERVICE_TMP="$WORK_DIR/jcohy-frameworktemp"
...
nohup $SERVICE_DIR/bin/admin-service > /dev/null 2>&1 &
